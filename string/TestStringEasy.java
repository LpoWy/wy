...
import static leetcode.string.easy.isValidEasy.isValidBracket2;
import static leetcode.string.easy.longestCommonPrefixEasy.longestCommonPrefix2;
import static leetcode.string.easy.romanToIntEasy.romanToInt;
...
public class TestStringEasy {
    ...
    public void longestCommonPrefixTest() {
        String str = longestCommonPrefix2(new String[]{"e-flower","flow","ee-flight"});
