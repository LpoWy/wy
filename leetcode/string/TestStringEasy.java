...
import java.leetcode.string.easy.longestCommonPrefixEasy;
import java.leetcode.string.easy.romanToIntEasy;

import static java.leetcode.string.easy.isValidEasy.isValidBracket2;

public class TestStringEasy {
    ...
    public void romanToIntTest() {
        int i = romanToIntEasy.romanToInt("III");
        System.out.println(i);
    }

    @Test
    public void longestCommonPrefixTest() {
        String str = longestCommonPrefixEasy.longestCommonPrefix2(new String[]{"e-flower","flow","ee-flight"});
        System.out.println(str);
    }

    @Test
    public void isValidBracketTest() {
        System.out.println(isValidBracket2("{(([]))}"));
    }
}
